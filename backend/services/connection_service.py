...
class ConnectionService:
    ...
    @handle_service_errors("Failed to create connection request")
    ...
    @handle_service_errors("Failed to fetch pending requests")
    ...
    @handle_service_errors("Failed to accept request")
    ...
    @handle_service_errors("Failed to reject request")
    ...
    @handle_service_errors("Failed to create connection")
    ...
    @handle_service_errors("Failed to create external contact")
    ...
    @handle_service_errors("Failed to fetch connections")
    ...
    @handle_service_errors("Failed to update connection")
    ...
    @handle_service_errors("Failed to update external contact")
    ...
    @handle_service_errors("Failed to delete connection")
